    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="max-w-sm mx-auto mt-8 sm:mt-16">
            <div className="space-y-3">
                ...
                <div className="overflow-hidden transition-all duration-200 bg-white border-2 border-primary rounded-md hover:bg-gray-50">
                    <div className="px-4 py-5 sm:p-6">
                        <div className="flex items-center">
                            <div>
            ...
            <Button className="inline-flex items-center justify-center w-full px-12 py-4 min-h-14 mt-6 font-semibold text-white transition-all duration-200   hover:opacity-80 focus:opacity-80" role="button"> Start Building Website </Button>
