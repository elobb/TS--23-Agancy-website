...
export default function SignupFormDemo() {
  ...
  return (
    <div className="shadow-input mx-auto w-full max-w-xl rounded-none bg-white p-4 md:rounded-2xl md:p-8 py-[70px] md:py-[120px] lg:py-[140px] dark:bg-black">
      <h2 className="text-3xl font-bold text-center text-neutral-800 dark:text-neutral-200">
        Welcome to Aceternity
      </h2>
      <p className="mt-2 max-w-sm  text-center mx-auto text-neutral-600 dark:text-neutral-300">
